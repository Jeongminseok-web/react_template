      ...
      <div className="container relative">
        <div className="nav_wrapper">
          ...
          <div className="sub_link_wrapper flex">
            ...
            <div className="mune_icon lg:hidden">
        ...
        {mobileMenuOpen && (
          <div className="sun_nav_mobile absolute bg-white w-full top-full left-0 dark:bg-neutral-900 mt-[1px] lg-hidden">
            <ul className="navi">
              {navItems.map((item, idx) => (
                <li
                  key={idx}
            ...
            <div className="sub_links flex py-4 gap-4 justify-center border-b border-neutral-600">
              {authLink.map((item, idx) => (
                <Link
                  className={`${
                    idx === 1 &&
